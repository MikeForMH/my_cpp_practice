//
//  main.cpp
//  multiple_inheritance_xuetangx_c7_2
//
...
Base2::Base2(int input){
    cout << "Base2 constructor called " << input << endl;
}
...
Base3::Base3(int input){
    cout << "Base3 constructor called " << input << endl;
}
